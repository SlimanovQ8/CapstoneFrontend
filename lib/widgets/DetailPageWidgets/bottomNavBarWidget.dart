                                                        ...
                                                        child: OutlinedButton(
                                                          ...
                                                          onPressed: () {
                                                            if (amount > widget.remaining)
                                                              ...
                                                              setS(() {
                                                                Future<void> u = Provider.of<AuthProvider>(context, listen: false).getUsers(authProvider.user.id!);
                                                                u.then((value) => {
                                                                ...
                                                                int points = amount + userProfile.users[0].points!;
                                                                int numOfDonation = userProfile.users[0].numOfDonation! +1;
